...
2. Open terminal and download the script by running the following in a terminal:
    ...
    ```bash
    wget https://github.com/jamincollins/k2-improvements/tree/main/features/cartographer/firmware/flash.sh
    ```
...
4. Open Ubuntu WSL (as Administrator) and download the flash script by entering
    ...
    ```bash
    wget https://github.com/jamincollins/k2-improvements/tree/main/features/cartographer/firmware/WSLFlash.sh
    ```
